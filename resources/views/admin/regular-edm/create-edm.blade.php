...
@section('content')
    <section class="add-section">
        <h3 class="admin-panel-title">Create Regular EDM</h3>
        ...
        <form id="create_edm_form" action="{{route('adminEdm.edit')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-check form-check-inline">
                    <label class="form-check-label">
                        <input class="form-check-input edm_section" type="checkbox" name="edm_section[0]" value="header"
                               @if( !old('edm_section')) checked @elseif(old('edm_section') && old('edm_section.0')) checked @endif> Header
                    </label>
                </div>
                <div class="form-check form-check-inline">
                    <label class="form-check-label">
                        <input class="form-check-input edm_section" type="checkbox" name="edm_section[1]" value="blog"
                               @if( !old('edm_section')) checked @elseif(old('edm_section') && old('edm_section.1')) checked @endif> Blog
                    </label>
                </div>
                <div class="form-check form-check-inline">
                    <label class="form-check-label">
                        <input class="form-check-input edm_section" type="checkbox" name="edm_section[2]"
                               value="instagram" @if( !old('edm_section')) checked @elseif(old('edm_section') && old('edm_section.2')) checked @endif> Instagram
                    </label>
                </div>
                <div class="form-check form-check-inline">
                    <label class="form-check-label">
                        <input class="form-check-input edm_section" type="checkbox" name="edm_section[3]" value="recipe"
                               @if( !old('edm_section')) checked @elseif(old('edm_section') && old('edm_section.3')) checked @endif> Recipe
                    </label>
                </div>
            </div>
            <div class="card-block">
            ...
            <fieldset id="header">
                ...
                <div class="card-block">
                    ...
                    <textarea class="form-control" name="header_content">{{old('header_content')}}</textarea>
                </div>
            </fieldset>
            <fieldset id="blog">
                <legend>Blog</legend>
                ...
                <div class="card-block row">
                    <div class="col-sm-4">
                        <div class="image-preview-holder no-image mt-4" id="blog_image-preview-holder">
                            <div class="image-preview-crop">
                                <img class="image-preview" id="blog_image-preview" src="">
                            </div>
                        </div>
                    ...
                    <div class="col-sm-8">
                        <div class="card-block">
                            ...
                            <input type="text" name="blog_image_alt" class="form-control"
                                   value="{{old('blog_image_alt')}}">
                        </div>
                    </div>
                </div>
                <div class="card-block">
                    <label>Blog Link</label>
                    <input type="text" name="blog_link" class="form-control" value="{{old('blog_link')}}">
                </div>
                <div class="card-block">
                ...
                <div class="card-block">
                    ...
                    <textarea class="form-control" name="blog_intro">{{old('blog_intro')}}</textarea>
                </div>
            </fieldset>
            <fieldset id="instagram">
                ...
                <div class="card-block row">
                    ...
                    <div class="col-sm-4">
                        <div class="image-preview-holder no-image mt-4" id="instagram_image_1-preview-holder">
                            <div class="image-preview-crop">
                                <img class="image-preview" id="instagram_image_1-preview" src="">
                            </div>
                        </div>
                        <div class="file-box pull-right mt-4">
                ...
                <div class="card-block row">
                    ...
                    <div class="col-sm-4">
                        <div class="image-preview-holder no-image mt-4" id="instagram_image_2-preview-holder">
                            <div class="image-preview-crop">
                                <img class="image-preview" id="instagram_image_2-preview" src="">
                            </div>
                        </div>
                        <div class="file-box pull-right mt-4">
                ...
                <div class="card-block row">
                    ...
                    <div class="col-sm-4">
                        <div class="image-preview-holder no-image mt-4" id="instagram_image_3-preview-holder">
                            <div class="image-preview-crop">
                                <img class="image-preview" id="instagram_image_3-preview" src="">
                            </div>
                        </div>
                        <div class="file-box pull-right mt-4">
                ...
                <div class="card-block row">
                    ...
                    <div class="col-sm-4">
                        <div class="image-preview-holder no-image mt-4" id="instagram_image_4-preview-holder">
                            <div class="image-preview-crop">
                                <img class="image-preview" id="instagram_image_4-preview" src="">
                            </div>
                        </div>
                        <div class="file-box pull-right mt-4">
            ...
            <fieldset id="recipe">
                ...
                <div class="card-block">
                    ...
                    <input type="text" name="recipe_title" class="form-control" value="{{old('recipe_title')}}">
                </div>
                <div class="card-block row">
                    <div class="col-sm-4">
                        <div class="image-preview-holder no-image mt-4" id="recipe_image-preview-holder">
                            <div class="image-preview-crop">
                                <img class="image-preview" id="recipe_image-preview" src="">
                            </div>
                        </div>
                        <div class="file-box pull-right mt-4">
                    ...
                    <div class="col-sm-8">
                        <div class="card-block">
                            ...
                            <input type="text" name="recipe_image_alt" class="form-control"
                                   value="{{old('recipe_image_alt')}}">
                        </div>
                    </div>
                </div>
                <div class="card-block">
                    <label>Recipe Link</label>
                    <input type="text" name="recipe_link" class="form-control" value="{{old('recipe_link')}}">
                </div>
                <div class="card-block">
                    <label>Recipe Content</label>
                    <textarea class="form-control" name="recipe_intro">{{old('recipe_intro')}}</textarea>
                </div>
            </fieldset>
            <div class="card-block">
