        ...
        <div class="container-fluid">
            <div class="row no-gutters">
                <div class="col">
                    <div class="row no-gutters">
                        <div class="col">
                            <h3 class="admin-panel-title pull-left">EDM List</h3>
                            <a href="{{route('adminEdm.create')}}" class="btn btn-main pull-right"><i class="fa fa-plus" aria-hidden="true"></i> Create EDM</a>
                        </div>
                    </div>
                    ...
                    @endif
                    <table id="edm-table" class="table table-bordered">
                        <thead>
                        <tr>
                            <th>ID</th>
                            <th>Name</th>
...
@section('footer-script')
    ...
    <script type="application/javascript">
        ...
        function deleteEDM(edmId) {
            var r = confirm("Are you sure to delete ingredient with id " + edmId + "?");
            if (r == true) {
                window.location.href = "{{route('adminEdm.delete')}}/" + edmId;
            }
        }
